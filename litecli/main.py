...
import litecli.packages.special as special
...
from litecli.compat import WIN
from litecli.packages.filepaths import dir_path_exists
...
class LiteCli(object):
    ...
    def run_cli(self):
        ...
        key_binding_manager = litecli_bindings()
    ...
    def _on_completions_refreshed(self, new_completer):
        ...
        with self._completer_lock:
            ...
            # When litecli is first launched we call refresh_completions before
...
def cli(database, user, password, dbname,
    ...
    if sys.stdin.isatty():
        ...
        if (litecli.destructive_warning and
